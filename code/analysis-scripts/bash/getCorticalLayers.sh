...
PRFPY_DIR=/home/mayajas/scratch/project-00-7t-pipeline-dev/output/prfpy_Iso2DGaussianModel/$SUBJECT_ID
...
if [ "$SPACE" = "anat" ]; then
    ...
    # laynii layerification
    $LAYNII_DIR/LN2_LAYERS -rim $LAYER_DIR/func_ribbon_rim.nii -nr_layers 10 -equivol
